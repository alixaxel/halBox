...
#
# halBox 0.41.0 (github.com/alixaxel/halBox/)
# Copyright (c) 2012 Alix Axel <alix.axel@gmail.com>

clear && echo -e "\e[1;31mhalBox 0.41.0\e[0m\n"
...
halBox_packages=$(dialog \
	...
	--checklist "Dave, select the packages to install." 0 0 0 \
			...
			git			"distributed revision control system"			off \
			...
			php5			"server-side, HTML-embedded scripting language"		on \
...
if [[ $halBox_packages == *"php5"* ]]; then
	halBox_PHP_packages=$(dialog \
		...
		--checklist "Dave, select the PHP packages to install." 0 0 0 \
			...
			php5-apcu		"APC User Cache Module"					on \
			php5-bitset		"Bitset PECL Module"					off \
			php5-chdb		"Constant Hash Database PECL Module"			off \
			php5-cld		"Compact Language Detector PECL Module"			off \
			...
			php5-event		"libevent PECL Module"					off \
			...
			php5-opcache		"Zend OPcache PECL Module"				off \
